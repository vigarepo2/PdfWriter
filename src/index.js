...
export default {
  async fetch(request) {
    ...
    if (path === '/health') return Response.json({ ok: true, app: 'PdfWriter', version: '3.0.0' });
    if (path === '/frontend/index.js') return response(FRONTEND_JS, 'application/javascript; charset=utf-8');
